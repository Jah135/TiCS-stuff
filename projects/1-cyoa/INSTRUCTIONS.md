...
- Use [CommonMark](https://commonmark.org/help/tutorial/index.html) to help with MarkDown
- Name the **README YI_TICS_PROJ1.md**
...
-  You **MAY** use AI to help develop the story arc.
